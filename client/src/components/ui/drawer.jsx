...
const drawerVariants = cva("fixed z-50 bg-background transition-transform duration-300", {
  variants: {
    side: {
...
const DrawerContent = React.forwardRef(({ side = "left", className, children, ...props }, ref) => (
  <DrawerPortal>
    <DrawerOverlay />
